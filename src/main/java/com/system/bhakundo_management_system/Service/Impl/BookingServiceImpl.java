...
import com.system.bhakundo_management_system.Repo.BookingRepo;
import com.system.bhakundo_management_system.Repo.UserRepo;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingPojo saveOrder(BookingPojo bookingPojo) {
        ...
        booking.setBhakundo(bhakundoRepo.findById(bookingPojo.getFid()).orElseThrow());
    ...
    public Booking fetchById(Integer id) {
        ...
        application =Booking.builder()
                ...
                .bhakundo(application.getBhakundo())
...
//        return time;
    ...
    private void sendPassword(String email, String name, String bhakundo, String date, String time){
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(email);
        message.setSubject("Booking Verification");
        message.setText("Hi"+ name+ "You have booked"+bhakundo+"bhakundo"+"on"+ date+"from"+time+"please be on time");
    ...
    public void processPasswordResetRequest(String email){
        ...
        if(bookingOptional.isPresent()){
            ...
            String bhakundo = booking.getBhakundo().getBhakundoname();
            String time = booking.getStarting();
            String date = String.valueOf(booking.getDate());
            sendPassword(email, name, bhakundo, time, date);
